...
class Transformer(nn.Module):
    def __init__(
        ...
        self.retriver = RobertaModel.from_pretrained('/media/team/data/CODE/transform/roabert')

        self.text_encoder =  RobertaModel.from_pretrained('/media/team/data/CODE/transform/roabert')
...
class TransformerEncoderLayer(nn.Module):
    ...
    def forward_post(
            self,
            src,  # [HW+batch_max_sequence_lenbs,d_model]
