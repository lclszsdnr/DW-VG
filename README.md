# DW-VG
## 🛠 Installation
Our main code is based on [VLM-R1](https://github.com/ashkamath/mdetr), please follow their instructions to set up the environment.
...
Parameter Training States (main)
